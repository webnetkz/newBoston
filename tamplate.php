    ...
    <html>
        ...
        <menu class="hiddenMenu">
            ...
            <div class="menuContent">
                ...
                <ul class="menuUl">
                    <a href="<?=$path?>pages/hire.php" class="menuLink">
                        <li class="menuItem">Прокат</li>
                    </a>
                    <a href="<?=$path?>pages/services.php" class="menuLink">
                        <li class="menuItem">Услуги</li>
                    </a>
                    <a href="<?=$path?>pages/goods.php" class="menuLink">
                        <li class="menuItem">Товары</li>
                    </a>
                </ul>

                <div>
                    <a href="<?=$path?>profile.php" class="menuLink">
